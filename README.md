...
### 🔹 Day 10 - Subqueries + MIN (Practice Reinforcement)
- MIN with conditions
- Subquery mapping
- Precision handling
...
├── day_10/ → Subqueries + MIN (Practice Reinforcement)                                                                                                                         
├── day_11/ → JOIN Reinforcement                                                                                                                                                                            
├── day_12/ → Aggregation Practice (MIN)                                                                                                                                                 
├── day_13/ → Subquery + Aggregation                                                                                                                                                                        
---
